    ...
    <section className="py-24 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg mb-10">Reach me here</p>
        </motion.div>
        ...
        >
          {socialLinks.map((social) => (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="w-14 h-14 rounded-full bg-card border border-border flex items-center justify-center group-hover:border-primary group-hover:bg-primary/10 transition-all duration-300">
                <svg className="w-6 h-6 fill-muted-foreground group-hover:fill-primary transition-colors duration-300" viewBox="0 0 24 24">
                  <path d={social.icon} />
                </svg>
              </div>
