...
export const Navbar = () => {
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 px-6 py-5 flex items-center justify-between bg-background/80 backdrop-blur-md border-b border-border/50"
    >
      <motion.span
      ...
      <div className="flex items-center gap-5">
        {socialLinks.map((social) => (
          <motion.a
            ...
            className="text-muted-foreground hover-spark"
